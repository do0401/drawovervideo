  ...
  methods: {
    ...
    draw () {
      ...
      this.canvas.on("click", e => {
        ...
        this.selected = e.target.attrs.id === "angle" ? e.target.parent : e.target.attrs.id === "eventArea" ? null : e.target
        selectedDiv.innerHTML = this.selected ? "selected: "+this.selected.attrs.id : "selected: "+null
      })
